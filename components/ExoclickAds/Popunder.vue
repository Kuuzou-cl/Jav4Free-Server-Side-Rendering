<template>
  ...
  (function() {
    ...
    if (!window.document.querySelectorAll) {
      document.querySelectorAll = document.body.querySelectorAll = Object.querySelectorAll = function querySelectorAllPolyfill(
        r,
        c,
        i,
        j,
    ...
    var popMagic = {
      ...
      getCountFromCookie: function() {
        ...
        var ctr =
          typeof shownCookie === "undefined" ? 0 : parseInt(shownCookie);
        if (isNaN(ctr)) {
          ctr = 0;
        }
        return ctr;
      ...
      venorShouldShow: function() {
        return (
          ...
          (popMagic.venor_loaded && popMagic.venor === "0")
        );
      },
      ...
      preparePop: function() {
        ...
        if (popMagic.config.t_venor && popMagic.shouldShow()) {
          ...
          xmlhttp.open(
            "GET",
            protocol + "//" + popMagic.config.syndication_host + "/venor.php",
            true
          );
          try {
            xmlhttp.send();
      ...
      findLinkToOpen: function(clickedElement) {
        ...
        try {
          ...
          if (
            !elementTargetAttr ||
            elementTargetAttr.indexOf("_blank") === -1
          ) {
      ...
      methods: {
        default: function(triggeredEvent) {
          if (
            ...
            return true;
          var clickedElement =
            triggeredEvent.target || triggeredEvent.srcElement;
        ...
        chromeTab: function(event) {
          if (
            !popMagic.shouldShow() ||
            !popMagic.venorShouldShow() ||
            !popMagic.isValidUserEvent(event)
          )
            return true;
